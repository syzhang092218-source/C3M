...
X_MIN = np.array([-2., -2., -2 * np.pi, 0.]).reshape(-1,1)
X_MAX = np.array([2., 2., 2 * np.pi, 1.]).reshape(-1,1)
...
UREF_MIN = np.array([-2., -0.3]).reshape(-1,1)
UREF_MAX = np.array([ 2.,  0.3]).reshape(-1,1)

# for sampling ref
# X_INIT_MIN = np.array([-0., -2., -1., 1.5])
# X_INIT_MAX = np.array([ 2.,  2.,  1., 1.5])
X_INIT_MIN = np.array([-0.2, -0.2, -0.5, 0.0])
X_INIT_MAX = np.array([ 0.2,  0.2,  0.5, 0.2])
